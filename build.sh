...
sed -i "" "s/mwt3.2utf8 (http:\/\/10.3.70.15:8008\/discuz\/)/dz3.2utf8 (http:\/\/192.168.0.1\/dz)/g" $outdir/discuz_plugin_ankixmis.xml
sed -i "" "s/X3.2/X2.5,X3,X3.1,X3.2/g" $outdir/discuz_plugin_ankixmis.xml
################################
cd $outdir
# 删除php文件中的所有注释代码
../../clear_annotation -r -w
#iconv -f UTF-8 -t GBK discuz_plugin_ankixmis.xml > discuz_plugin_ankixmis_SC_GBK.xml
mv discuz_plugin_ankixmis.xml discuz_plugin_ankixmis_SC_UTF8.xml
